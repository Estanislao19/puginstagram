<script>
    ...
    let isModal = false;
    let like = false;
    let bookmark =false; //para guardar la publicacion
    ...
    function handlelike(){
      like = !like //si like es falso lo convierto en verdadero
      if(like) {
        likeCount.update(n => n + 1)//actualiza el valor del estado
      }else {
